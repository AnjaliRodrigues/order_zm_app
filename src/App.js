...
export default function App() {
  return (
    <div class="ml-5 mr-5 mb-11 pb-9">
      <h1 class=" mb-3 mt-3 ml-2 font-bold ">Orders</h1>

      <div
        class="inline-flex  rounded-md shadow-sm whitespace-pre-wrap"
        role="group"
      >
        <All />
      </div>
      <div
        class="inline-flex mt-1 rounded-md shadow-sm whitespace-pre-wrap"
        role="group"
      >
        <Pending />
      </div>
